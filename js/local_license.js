...
function show_feature_info(evt) {
	...
	if((filter_region == '00') || (filter_region == '') || (!filter_region)) { 
		...
		str += "<table>";
			str += "<tr>";
				str += "<td colspan='2'><p style='font-weight: bold;'>จำนวนใบอนุญาตตาม พรบ.</p></td>";
			str += "</tr>";
			str += "<tr>";
				str += "<td>พรบ.สุรา</td>";
				str += "<td class=\"right\">" + Number(f_sum1).toLocaleString('en', { minimumFractionDigits: 0 }) + " ใบ</td>";
			str += "</tr>";
			str += "<tr>";
				str += "<td>พรบ.ยาสูบ</td>";
				str += "<td class=\"right\">" + Number(f_sum2).toLocaleString('en', { minimumFractionDigits: 0 }) + " ใบ</td>";
			str += "</tr>";
			str += "<tr>";
				str += "<td>พรบ.ไพ่</td>";
				str += "<td class=\"right\">" + Number(f_sum3).toLocaleString('en', { minimumFractionDigits: 0 }) + " ใบ</td>";
			str += "</tr>";
			str += "<tr>";
				str += "<td>พรบ.2527</td>";
				str += "<td class=\"right\">" + Number(f_sum4).toLocaleString('en', { minimumFractionDigits: 0 }) + " ใบ</td>";
			str += "</tr>";
			str += "<tr>";
				str += "<td>รวม</td>";
				str += "<td class=\"right\">" + Number(f_sumAll).toLocaleString('en', { minimumFractionDigits: 0 }) + " ใบ</td>";
			str += "</tr>";
		str += "</table>";
		...
		for (i = 0; i < map_data_area.features.length; i++ ) {
			...
			if(ci == cj) {
				...
				str += "<table>";
					...
					str += "<tr>";
						str += "<td>พรบ.สุรา</td>";
						str += "<td class=\"right\">" + Number(f_sum).toLocaleString('en', { minimumFractionDigits: 0 }) + " ใบ</td>";
					str += "</tr>";
					str += "<tr>";
						str += "<td>พรบ.ยาสูบ</td>";
						str += "<td class=\"right\">" + Number(f_sum).toLocaleString('en', { minimumFractionDigits: 0 }) + " ใบ</td>";
