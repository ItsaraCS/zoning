...
function on_page_loaded() {
	...
	// Attribute data
	load_data_region('API/taxmapAPI.php?data=stamp_reg&year=2017');
	load_data_region_monthly('API/taxmapAPI.php?data=stamp_month&year=2017');
	load_data_area('API/taxmapAPI.php?data=stamp_area&year=2017');
