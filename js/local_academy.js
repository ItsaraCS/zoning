...
function on_page_loaded(currentYear) {
	...
	// Attribute data
	load_data_region('API/taxmapAPI.php?data=academy_reg&year='+ currentYear);
	load_data_region_monthly('API/taxmapAPI.php?data=academy_month&year='+ currentYear);
	load_data_area('API/taxmapAPI.php?data=academy_area&year='+ currentYear);
...
function load_data_by_year(year) {
	if(year != '' && year != undefined) {
		load_data_region_for_change_year('API/taxmapAPI.php?data=academy_reg&year='+ year);
		load_data_region_monthly_for_change_year('API/taxmapAPI.php?data=academy_month&year='+ year);
		load_data_area_for_change_year('API/taxmapAPI.php?data=academy_area&year='+ year);
	}
}
