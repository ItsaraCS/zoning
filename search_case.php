            ...
            <div class="col-md-4">
                <div class="panel panel-default" style="border-radius: 0; border: 0;">
                    <div class="panel-body" style="padding: 0;">
                        <table class="table table-striped table-bordered search-detail-table bg-info" style="margin-top: 0; margin-bottom: 0;">
                            <thead><tr></tr></thead>
                            <tbody></tbody>
                        </table>
                            ...
                            <tbody>
                                <tr>
                                    <td class="col-md-12" style="padding: 10px !important;">
                                        <input class="form-control input-sm" id="FilterKeySearch" placeholder="ค้นหาชื่อผู้กระทำผิด / เลขบัตรประชาชน">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
