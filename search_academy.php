                            ...
                            <tbody>
                                <tr>
                                    <td class="col-md-12" style="padding: 10px !important;">
                                        <input class="form-control input-sm" id="FilterKeySearch" placeholder="ค้นหาชื่อสถานศึกษา">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    if(hit) {
                        if(hit.get('NAME') != undefined) {
                            ...
                            var contentPopup = '<div class="text-center" style="width: 300px;">' +
                                    ...
                                    '<h4 style="width: 240px; margin-top: 0; color: #333333;">' + hit.get('NAME') +'</h4>' +
                                    '<div class="table-responsive" style="width: 240px;">' +
                                        '<table class="table table-bordered" style="margin: 0;">' +
                                            '<thead>' +
                                                ...
                                                '<th class="text-nowrap text-center" style="font-size: 10px;">ที่ตั้ง</th>' +
                                                '<th class="text-nowrap text-center" style="font-size: 10px;">จังหวัด</th>' +
                                            ...
                                            '<tbody>' +
                                                ...
                                                '<th class="text-nowrap" style="font-size: 10px;">' + hit.get('TAMTNAME') +' '+ hit.get('AMPTNAME') +' '+ hit.get('PROVINCE') +'</th>' +
                                                '<th class="text-nowrap" style="font-size: 10px;">' + hit.get('PROVINCE') +'</th>' +
                                                '<th class="text-nowrap text-center" style="font-size: 10px;">' + ((hit.get('TYPE') != 'NULL') ? hit.get('TYPE') : '-') +'</th>' +
